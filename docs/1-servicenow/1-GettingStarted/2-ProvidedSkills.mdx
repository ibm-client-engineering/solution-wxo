...
<details>
<summary><strong>Non-Functional or Incomplete Skills</strong></summary>

:::danger
These are skills that you can see commented-out (#) in the script and are either unutilized or under construction. Enable and modify at your own risk.
:::
