...
#### Steps
1. Download the latest .yaml file <a href="https://github.com/ibm-client-engineering/solution-wxo/blob/main/assets/servicenow/scripts/JC%20-%20Watsonx%20Orchestrate%20ServiceNow%20API.yml">here</a>
