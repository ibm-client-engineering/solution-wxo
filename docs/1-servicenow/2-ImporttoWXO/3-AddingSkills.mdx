...
2. Find and select "JC - ServiceNow Table API" from the list
3. Connect the app
...
The skills should now be added to your catalog under "JC - ServiceNow Table API" and ready for use directly or in a composite Skill flow.
