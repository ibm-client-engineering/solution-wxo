...
:::tip
This enables us to use these Watsonx API skills and their outputs in a skill flow with any other Watsonx Orchestrate skill that uses a string (text) input/output parameter.

Don't think of it as simply sending a prompt, but a way to generate text, modify text, or instruct based on a text input.
